...
if __name__ == "__main__":
    ...
    for tau in [0.5]: # chose 0.8?
        for every in [50]:
            for mu in [0.5, 1.0, 5.0]:
                res = read_rewards_multi("results_zz/meta_CartPole-v0_vpg_s{}_n{}_every{}_goal0.5_c0.5_tau{}_mass{}".format(s,n,every,tau,mu), s, n, 5)
                plt.plot(xs, smooth(res, 0.9), label="mu:"+str(mu))
