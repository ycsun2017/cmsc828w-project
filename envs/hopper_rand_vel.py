...
class HopperEnvRandVel(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
    ...
    def step(self, a):
        ...
        vel_x = (posafter - posbefore) / self.dt  # *modification*
        reward = - np.abs(vel_x - self._goal_vel) + 1.0  # *modification* make it happy, not suicidal
